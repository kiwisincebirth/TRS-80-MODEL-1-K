...
- The Schematics in PDF Format [Schematics PDF Format](/pcb/TRS-80-MP-SchematicsV2b.pdf)
- Gerber files for manufacture [JLCPCB ZIP](/pcb/TRS-80-MP_JLCPCBV2b.zip) and [PCBWAY ZIP](/pcb/TRS-80-MP_PCBWayV2b.zip)
- Bill of Materials [BOM CSV Format](/pcb/TRS-80-MP-BillOfMatV2b.csv)
- A visual BOM is also available [VISUAL BOM](/pcb/TRS-80-MP-BomVisualV2b.html)
